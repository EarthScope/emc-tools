...
**Release 2.0 Note**: The R2 release has made changes to the GeoCSV fields. The R1 GeoCSV files **are not** 
compatible with the R2 tools. However, you could use the netCDF files generated by the R1 package to generate R2 style 
GeoCSV files using the **EMC Tools Release 2.0** script from the R2 release.
